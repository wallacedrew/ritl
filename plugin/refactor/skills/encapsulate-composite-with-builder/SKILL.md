...
description: Apply Encapsulate Composite With Builder when you see Long Function, Hide Delegate, Extract Class. A construction site that reads as a tree literal the agent parses structurally in one pass.
---

# Apply: 70 — Encapsulate Composite With Builder
