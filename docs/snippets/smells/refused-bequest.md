...
**Or decline first:** if you don't flag this as Refused Bequest, name the decline type — catalog miss, taste call, cost-benefit, constraint-blocked, or insufficient context.
