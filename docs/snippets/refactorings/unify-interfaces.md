...
**Or decline first:** if you don't see a chain pointing at Unify Interfaces, name the decline type — no chain, taste call, cost-benefit, constraint-blocked, or insufficient context.
