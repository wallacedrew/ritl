...
| ADR-0003 | Cloudflare Email Routing for inbound feedback      | accepted               | 2026-05-16 | Forward `feedback@` to the owner's Gmail via Cloudflare Email Routing; no outbound sending. Domain moved by ADR-0015. |
...
| ADR-0012 | Expanded word budget: 50–75 words per field        | superseded by ADR-0013 | 2026-06-04 | Widen ADR-0010 §5 budget from 25/50 to 50/75 words per field; same range applies to both human and agent columns.     |
| ADR-0013 | Word budget narrowed to 40–60 per field            | accepted               | 2026-06-04 | Narrow ADR-0012's 50/75 budget to 40/60 per field after the 75-word ceiling proved too generous in the first pass.    |
| ADR-0014 | House voice: the catalog-register family           | accepted               | 2026-06-05 | Anchor non-catalog prose to Fowler/Beck/Kerievsky/Ottinger/Hill; weight registers per surface; bite budget explicit.  |
| ADR-0015 | Migrate primary domain to refactorplug.com         | accepted               | 2026-06-27 | Make `refactorplug.com` canonical; 301 from the old domain; reuse ADR-0003 Email Routing on the new zone.             |
