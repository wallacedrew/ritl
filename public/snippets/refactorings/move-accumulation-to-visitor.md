...
# Apply: 80 — Move Accumulation To Visitor
...
**Or decline first:** if you don't see a chain pointing at Move Accumulation To Visitor, name the decline type — no chain, taste call, cost-benefit, constraint-blocked, or insufficient context.
